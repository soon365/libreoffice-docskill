...
void TemplateDefaultView::UpdateColors(const StyleSettings& rSettings)
{
    ...
    // DocSkill: use the standard light window background/text so the template
    // grid forms one continuous surface with the DocSkill browse tabs and the
    // rest of the Start Center, instead of the stock dark-grey thumbnail canvas.
